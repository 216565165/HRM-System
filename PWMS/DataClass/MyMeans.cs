...
namespace PWMS.DataClass
{
    ...
    class MyMeans
    {
        ...
        public static string M_str_sqlcon = "Data Source=DESKTOP-2DRN847\\FIRST;Database=db_PWMS;User id=sa;PWD=15013227986";
        //public static string M_str_sqlcon = "Data Source=FIRST;Initial Catalog=db_PWMS;Integrated Security=True";
